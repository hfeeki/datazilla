...
# TODO @@@ Discuss with Jeads and Carljm
# these should become static attributes on a class.  But which class?
# perhaps my resource class?  Or is that where we should have another model
# for them?
